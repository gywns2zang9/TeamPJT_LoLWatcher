package com.collect.data.dto.match.info.participant;


import com.collect.data.dto.match.info.participant.perk.PerksDto;
...
public record ParticipantDto(int allInPings,
                             ...
                             int playerScore8, int playerScore9, int playerScore10, int playerScore11,
